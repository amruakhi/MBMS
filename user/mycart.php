        ...
        <div class="container">
            ...
            <tr id="header">
			  ...
			  while($row=mysql_fetch_array($result))
				  $usid=$row['uid'];
              $result = mysql_query("SELECT * FROM ureg NATURAL JOIN ordermain WHERE ureg.uid=ordermain.uid AND ordermain.uid='$usid'");
			  ...
			  <td><?php if($row['pstatus']==0){
			  echo "<a href='cancel.php?id=$row[orderid]' id='reject' >Cancel</a>";
			   }
			   else{
				   echo"You can't cancel the order.Because it is payed";
			   }
			   ?>
              </td>
              </tr>
