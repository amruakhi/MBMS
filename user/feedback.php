	...
	if(isset($_POST['register']))
   {
    ...
    $date=date('y-m-d');
        ...
        while($row=mysql_fetch_array($sq))
        {
            ...
            $sql="INSERT INTO feedback VALUES ('','$id','$feedback','$date')";
    ...
    <div class="contact-box-main">
        <div class="container">
                            ...
                            <div class="row">
								...
								<div class="col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control" id="message" name="msg" placeholder="Your Feedback" rows="4" data-error="Write your feedback" required></textarea>
            ...
            <tr id="header">
              ...
              $result = mysql_query("SELECT * FROM feedback WHERE uid='$id'",$con);
