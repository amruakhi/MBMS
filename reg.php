...
<?php
	...
	if(isset($_POST['register']))
   {
	...
	if($flag==0)
    {
        ...
        {
            if($row['umailid']==$email||$row['uphno']==$phno)
            {
                $flag=1;
            }
        }
        ...
        else if($flag==0)
        {
            ...
            $sql="INSERT INTO ureg VALUES ('','$name','$address','$phno','$email')";
            if(mysql_query($sql,$con))
            {
                $sql1="INSERT INTO login VALUES ('$email','$password','user',0)";
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Your Name" pattern='[a-zA-Z\s]{3,30}' title='Min 3 characters and Max 30 characters. Only Letters permitted' required >
