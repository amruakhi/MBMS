...
<?php
	...
	if(isset($_POST['register']))
   {
    ...
    $target_file=$id."_".$itemname.".jpg";           //filename
	move_uploaded_file($_FILES["fileToUpload"]["tmp_name"],$target_dir.$target_file);    //uploading
    $file="uploads/".$target_file;      //dbfield info
			
            $sql="INSERT INTO items VALUES ('','$id','$itemname','$itemrate','$details','1','$file')";
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="name" name="itemname" placeholder="Item Name" pattern='[a-zA-Z\s]{3,30}' title='Min 3 characters and Max 30 characters. Only Letters permitted' required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
								<div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="name" name="itemrate" placeholder="Item Rate " required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
								<div class="col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control" id="message" name="details" placeholder="Item Details" rows="4"  required></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
								<div class="col-md-12">
