    ...
    <div class="contact-box-main">
        <div class="container">
            ...
            <tr id="header">
              ...
              $result = mysql_query("SELECT * FROM ordermain WHERE gid='$id' AND pstatus='1'",$con);
			  ...
			  <?php
				  ...
				  {
				      echo "<td><a href='ship.php?id=$row[orderid]'id='approve'>Shipped</a></td>";
				  }
				  elseif($row['dstatus']==2)
				  {
					  echo "<td>Order on route</td>";
				  }
			      else
				  {
