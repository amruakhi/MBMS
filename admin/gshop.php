...
<body>
    ...
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Product sellers Requests</h2>
                    <ul class="breadcrumb">
    ...
    <div class="contact-box-main">
        <div class="container">
            ...
            <tr id="header">
              ...
              $result = mysql_query("SELECT * FROM greg NATURAL JOIN login WHERE greg.gmailid=login.username AND type='groceryshop'AND status='1'");
