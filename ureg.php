...
<body>
    ...
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Grocery Shop Registration</h2>
                    <ul class="breadcrumb">
...
<?php
	...
	if(isset($_POST['register']))
   {
	$flag=0;           
    $name=$_POST['gname'];
    $oname=$_POST['ownername']; 	        //gname,ownername,licno,address
    $licno=$_POST['licno']; 	        
    ...
    {
        $pass=md5($_POST['pswd']);
        $data="SELECT * FROM greg natural join login";
        $c=0;
        $sd="SELECT * FROM greg";
        ...
        {
            if($row['gmailid']==$email||$row['gphno']==$phno)
            {
                $flag=1;
            }
        }
        ...
        {
		    $target_dir = "images/licenseimg/";
			$target_file=$email.".jpg";
			move_uploaded_file($_FILES["fileToUpload"]["tmp_name"],$target_dir.$target_file);   
			$file="images/licenseimg/".$target_file; 
			
            $sql="INSERT INTO greg VALUES ('','$name','$oname','$licno','$file','$address','$phno','$email')";
            if(mysql_query($sql,$con))
            {
                $sql1="INSERT INTO login VALUES ('$email','$password','groceryshop',0)";
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="name" name="gname" placeholder="Grocery Shop Name" pattern='[a-zA-Z\s]{3,30}' title='Min 3 characters and Max 30 characters. Only Letters permitted' required >
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
								<div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="name" name="ownername" placeholder="Owner Name" required >
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
								<div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="name" name="licno" placeholder="License Number" required >
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
								<div class="col-md-12">
